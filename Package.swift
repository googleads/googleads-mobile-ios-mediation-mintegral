...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "MintegralAdapter",
      url:
        "https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.1.4.0.zip",
      checksum: "99764c8b6b631f9c3e2ba12a18945949680e9102e1e1d899aa89430cfb013ce2"
    ),
  ]
)
